...
from leverages.runner import LeveragePruneRunner

registered_runners = {'train': TrainingRunner, 'lottery': LotteryRunner, 'lottery_branch': BranchRunner, 'leverage': LeveragePruneRunner}
