...
class LeverageDesc(Desc):
    ...
    def add_args(parser: argparse.ArgumentParser, defaults: 'LeverageDesc' = None):
        ...
        LeverageDesc._add_rewinding_argument(pretraining_parser)
        LeverageDesc._add_pretrain_argument(pretraining_parser)
    ...
    @classmethod
    def create_from_args(cls, args: argparse.Namespace) -> 'LeverageDesc':
