...
class Branch(Runner):
    ...
    @property
    def lottery_desc(self) -> LeverageDesc:
    ...
    class ArgHparams(Hparams):
        ...
        _name: str = 'Leverage Ticket Hyperparameters'
    ...
    @classmethod
    def create_from_hparams(cls, replicate, levels: List[int], desc: LeverageDesc, hparams: Hparams, verbose=False):
