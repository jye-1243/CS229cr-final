...
from lottery.runner import LeveragePruneRunner
...
class TestRunner(test_case.TestCase):
    ...
    def test_level0_2it(self):
        ...
        LeveragePruneRunner(replicate=2, levels=0, desc=self.desc, verbose=False).run()
    ...
    def test_level3_2it(self):
        self.desc.training_hparams.training_steps = '2it'
        LeveragePruneRunner(replicate=2, levels=3, desc=self.desc, verbose=False).run()
